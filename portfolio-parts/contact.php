        ...
        <div class="contact-content">
            <div class="contact-info">
                ...
                <div class="social-links">
                    ...
                    <a href="<?php echo esc_url($social_github); ?>" class="social-link" target="_blank" rel="noopener" aria-label="GitHub">
                    ...
                    <a href="<?php echo esc_url($social_linkedin); ?>" class="social-link" target="_blank" rel="noopener" aria-label="LinkedIn">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="<?php echo esc_url($social_twitter); ?>" class="social-link" target="_blank" rel="noopener" aria-label="Twitter">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
